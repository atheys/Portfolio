...
# Conversion latitude/longitude/altitude values to flat earth coordinates
# LLA to FE-XYZ
# Source: https://en.wikipedia.org/wiki/Mercator_projection
# NOTE[1]: in an 80-by-80 km area of experiment, the offset can be up to 59m
# NOTE[2]: Mercator cilindrical projection is used with L_0=0 
def convertToXY2(lat,lon,alt):
    x = alt
    y = eRadiusEquator*lon
    z = eRadiusEquator*log(tan(0.25*pi+0.5*lat))
    return x,y,z
